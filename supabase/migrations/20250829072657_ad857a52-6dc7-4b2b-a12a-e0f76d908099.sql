...
create policy "Organizers can upload student photos"
on storage.objects
for insert
with check (
...
create policy "Organizers can update student photos"
on storage.objects
for update
using (
  bucket_id = 'student-photos'
...
create policy "Organizers can delete student photos"
on storage.objects
for delete
using (
  bucket_id = 'student-photos'
