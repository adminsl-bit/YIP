...
import { LogOut, User, Users, Calendar, Newspaper, GraduationCap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 -right-40 w-[28rem] h-[28rem] bg-gradient-to-bl from-red-500/25 to-red-300/15 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-0 left-1/2 w-80 h-80 bg-gradient-to-t from-orange-500/30 to-orange-300/15 rounded-full blur-2xl animate-pulse delay-500"></div>
        ...
        <div className="absolute top-3/4 left-1/3 w-8 h-8 bg-red-400/25 rounded-full animate-bounce shadow-lg shadow-red-400/20" style={{animationDelay: '1s', animationDuration: '4s'}}></div>
        <div className="absolute top-1/2 right-1/4 w-5 h-5 bg-orange-400/35 rounded-full animate-bounce shadow-lg shadow-orange-400/20" style={{animationDelay: '2s', animationDuration: '3.5s'}}></div>
      </div>
      ...
      <nav className="relative z-10 p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/15 backdrop-blur-lg border-b border-white/25 shadow-xl">
        <div className="flex items-center gap-4 sm:gap-6">
          <div className="relative">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30">
              <Newspaper className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
            </div>
            <div className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-red-400/40 rounded-full animate-bounce"></div>
          </div>
          <div className="text-center sm:text-left">
            <h1 className="text-xl sm:text-2xl font-black text-slate-800 tracking-tight">Journalist Portal</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <div className="relative inline-block mb-6 sm:mb-8">
              <h2 className="responsive-text-3xl font-black text-transparent bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 bg-clip-text tracking-tight drop-shadow-lg">
            ...
            <div className="bg-white/20 backdrop-blur-lg rounded-2xl sm:rounded-3xl border border-white/25 responsive-padding shadow-xl max-w-xl sm:max-w-2xl mx-auto">
              <p className="responsive-text-base text-slate-700 font-semibold">
                You are covering the event as <span className="font-black text-transparent bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text">{profile?.position}</span>
              </p>
            </div>
          </div>
