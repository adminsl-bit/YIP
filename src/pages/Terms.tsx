      ...
      <main className="pt-32 pb-24">
        <section className="max-w-4xl mx-auto px-8">
          ...
          <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-outline-variant/15 space-y-8 text-on-surface-variant leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-headline font-bold text-primary mb-4">2. Participation</h2>
            ...
            <div>
              <h2 className="text-2xl font-headline font-bold text-primary mb-4">3. Consent for Use of Personal Information</h2>
            ...
            <div>
              <h2 className="text-2xl font-headline font-bold text-primary mb-4">5. General</h2>
            ...
            <div className="pt-6 border-t border-outline-variant/30">
              <h2 className="text-2xl font-headline font-bold text-primary mb-4">6. Acknowledgment and Agreement</h2>
