      ...
      <nav className="relative z-10 p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-center gap-4 bg-white/15 backdrop-blur-lg border-b border-white/25 shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          ...
          <Button
            onClick={signOut}
            variant="outline"
            className="bg-white/20 backdrop-blur-sm border-white/30 text-slate-800 hover:bg-white/35 hover:scale-105 transition-all duration-300 shadow-lg px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-semibold"
          >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Tabs defaultValue="controls" className="w-full">
            ...
            <TabsContent value="controls" className="space-y-6">
              {/* Feature Toggles (includes Assessment Locks accordion) */}
