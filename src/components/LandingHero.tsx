        ...
        <div className="px-8 py-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <Badge className="mb-8 px-6 py-3 text-lg bg-slate-800/10 border-slate-800/20 text-slate-800 hover:bg-slate-800/20">
              ...
              <p className="text-5xl lg:text-6xl font-bold mb-6 text-slate-700">
            ...
            <div className="mb-16">
              <div className="grid md:grid-cols-3 gap-12 text-center max-w-5xl mx-auto">
                <div className="group">
                  ...
                  <h3 className="text-xl font-bold mb-2 text-slate-800">Future Leaders</h3>
                  <p className="text-slate-600 text-sm">Shaping tomorrow's democratic leaders through debate and discourse</p>
                </div>
                ...
                <div className="group">
                  ...
                  <h3 className="text-xl font-bold mb-2 text-slate-800">Democratic Values</h3>
                  <p className="text-slate-600 text-sm">Building strong democratic foundations for India's future</p>
                </div>
                ...
                <div className="group">
                  ...
                  <p className="text-slate-600 text-sm">Recognizing outstanding parliamentary performance and leadership</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
                <div className="bg-slate-800/10 backdrop-blur-sm border border-slate-800/20 rounded-full px-6 py-3 text-slate-800 hover:bg-slate-800/20 transition-all duration-300 hover:scale-105">
