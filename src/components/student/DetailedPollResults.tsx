  ...
  return (
    <div className="h-full flex flex-col bg-surface-container-low overflow-hidden">
      ...
      <header className="flex justify-between items-center px-10 py-4 w-full shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="bg-white/70 backdrop-blur-[20px] px-5 py-2.5 rounded-full flex items-center gap-3 border border-outline-variant/20 shadow-sm">
            ...
            <span className="font-headline font-bold text-on-surface-variant text-sm tracking-wide truncate max-w-[260px]">
          ...
          {isOrganizer && (
            <div className="flex items-center gap-1.5">
              <button
                onClick={downloadCSV}
                title="Download CSV"
                className="group relative w-9 h-9 rounded-full bg-surface-container-lowest border border-outline-variant/10 flex items-center justify-center text-on-surface-variant/60 hover:bg-primary hover:text-white hover:border-primary transition-all shadow-sm"
              >
                <Download className="w-3.5 h-3.5" />
                <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 text-[9px] font-black uppercase tracking-widest text-on-surface-variant/40 font-headline opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">CSV</span>
              </button>
              <button
                onClick={downloadPDF}
                title="Download PDF"
                className="group relative w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white hover:opacity-80 transition-all shadow-sm shadow-primary/20"
              >
                <Download className="w-3.5 h-3.5" />
                <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 text-[9px] font-black uppercase tracking-widest text-on-surface-variant/40 font-headline opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">PDF</span>
              </button>
            </div>
          )}
        </div>
      ...
      <div className="flex items-center justify-between px-10 pb-3 shrink-0 border-b border-outline-variant/10">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-on-surface-variant/40 font-headline">
            <Users className="w-3 h-3" />{totalDelegates} Delegates
          </span>
          <span className="flex items-center gap-1.5 text-[11px] font-semibold text-on-surface-variant/30 font-headline">
