      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-6"
          >
            <div className="bg-gradient-to-br from-blue-50/80 to-indigo-50/80 backdrop-blur-xl rounded-2xl p-6 border border-blue-200/50 shadow-lg">
              <div className="flex items-start gap-3 mb-4">
                <Crown className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="text-slate-800 font-bold text-base">Demo Login Credentials</h3>
                  <p className="text-slate-600 text-xs mt-1">Use these credentials for testing</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-green-200/60">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    <div>
                      ...
                      <p className="font-mono font-semibold text-slate-800">password</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Organizer Demo */}
                <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-blue-200/60">
                  <div className="flex items-center gap-2 mb-2">
                    <Shield className="w-4 h-4 text-blue-600" />
                    <span className="font-semibold text-blue-700 text-sm">Organizer</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div>
                      <span className="text-slate-500">Email:</span>
          ...
          <motion.div
            ...
            className="mt-4"
          >
            <div className="bg-white/15 backdrop-blur-xl rounded-2xl p-5 border border-white/20 shadow-lg">
              <div className="flex items-start gap-3">
                <Info className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
                <div className="space-y-2">
                  <h3 className="text-slate-800 font-semibold text-xs">How Login Works</h3>
                  <div className="space-y-1.5 text-xs text-slate-700">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-slate-600 ml-1">Serial # + Party # = Login ID</span>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-slate-600 ml-1">Use email address</span>
                      </div>
                    </div>
                  </div>
                </div>
